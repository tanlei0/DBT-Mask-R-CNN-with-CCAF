...
def main(args):
    ...
    if imp is not None:
        train_dataset = CrackLS315(data_root, dataset="train_imp",transforms=data_transform["train"])  
    else:  
        train_dataset = CrackLS315(data_root, dataset="train",transforms=data_transform["train"])
    ...
    if imp is not None:
        val_dataset = CrackLS315(data_root, dataset="test_imp",transforms=data_transform["val"])  
    else:  
...
if __name__ == "__main__":
    ...
    parser.add_argument("--imp", default=None, type=bool, help="Switch for CCAF")
